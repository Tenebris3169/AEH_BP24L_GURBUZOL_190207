...
public class MyFifthApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter a character to display: ");
        char character = scanner.next().charAt(0);

        System.out.print("Enter how many times the character should be printed per line: ");
        int timesPerLine = scanner.nextInt();

        System.out.print("Enter how many lines should be printed: ");
        int numberOfLines = scanner.nextInt();

        printCharacterGrid(character, timesPerLine, numberOfLines);
...
*/
    ...
    // === NEW METHOD ===
    private static void printCharacterGrid(char ch, int timesPerLine, int numberOfLines) {
    ...
    // === ORIGINAL METHODS (Commented Out) ===
/*
